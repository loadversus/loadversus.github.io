                        ...
                        <div class="wrapp1">	
                            ...
                            <section id="head">
                                <div class = "row">
                                    ...
                                    <div class = "col-lg-3 col-md-3 col-sm-3 phone"><a href="tel://+380934252233">+38(093) 425 22 33</a><br>
                    ...
                    <div class="wrapp1" style="position:relative">
                        <div class = "remont col-lg-7 col-md-7 col-sm-7">
                            <div class="remontWrapper">
                                ...
                                <p style="  background: #FDD621; padding-top: 5px;  font-size: 27px;">частично и "под ключ" с оплатой по факту и точными сроками</p>
                                <ul style="font-size: 20px; ">
                                    <li>Бюджет на ремонт расчитываеться интдивидуально</li>											
                                    <li>Бесплатный расчет сметы на ремонтные работы</li>
                                    <li>Скидки на некоторые материалы до 20%!</li>
                ...
                <div class = "row">
                    <div class = "wrapp1">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 advantagesBox">
                            ...
                            <h4>Скидки <br>на материалы</h4>
                            <p>Экономьте до 20% на некоторые материалы</p>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 advantagesBox">
                            ...
                            <div class="row">
                                <div class = "wrapp1">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 garantBox">
                                        ...
                                        <p>Мы работаем по плану и завершаем <br/>проекты вовремя</p>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12 garantBox">
                                        <img>Гарантия на работы</h4>
...
<section class="maps wrapp">
<h3 class="mainCaption">Наши адрес</h3>
               <div class="map">
			  <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10256.662372323299!2d36.3187268!3d50.0082514!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x5f6c183d32f218c!2z0JDQoNCiINCQ0LvRjNGP0L3RgQ!5e0!3m2!1sru!2sru!4v1563020723056!5m2!1sru!2sru" width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
			   </div>
            ...
            <footer class="wrapp">
                ...
                <div class="footerPhone"><a href="tel://+380934252233">+38(093) 425 22 33</a><br>
