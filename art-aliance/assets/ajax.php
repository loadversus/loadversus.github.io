...
$recepient = "artalliancekh@gmail.com"; //artsashasanin@gmail.com";  
$siteName = "art-alliance.kh.ua";
    ...
    print '[
        {
          "result": {
            "status": "success",
            "code": "<script>(function($){ $(document).ready(function(){ga(\"send\", \"event\", \"' . $counter . '\", \"submit\"); yaCounter48115166.reachGoal(\"' . $counter . '\");console.log(\"' . $counter . '\")})})(jQuery);</script>"
          }
        }
      ]';
}else{
